...
class ThoughtsControllerTest < ActionController::TestCase
  ...
  test "should create thought" do
    assert_difference('Thought.count') do
      post :create, thought: { category: @thought.category, content: @thought.content, preview: @thought.preview, title: @thought.title, tldr: @thought.tldr }
    end
  ...
  test "should update thought" do
    patch :update, id: @thought, thought: { category: @thought.category, content: @thought.content, preview: @thought.preview, title: @thought.title, tldr: @thought.tldr }
    assert_redirected_to thought_path(assigns(:thought))
  end
